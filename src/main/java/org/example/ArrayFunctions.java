...
public class ArrayFunctions { 
    ...
    public int[] leftRotatebyOne(int myarr[])
    {   
        int len = myarr.length;
        int arr[] = new int[len];
    ...
    //reverse the array
    public int [] reverseArray(int myarr[])
    {
        int len = myarr.length;
        int arr[] = new int[len];
        for(int i = 0; i < len; i++)
    ...
    public int[] leftRotatebyK(int myarr[], int d)
    {   
        int n = myarr.length;
        int arr[] = new int[n];
        for(int i = 0; i < n; i++)
    ...
    public boolean chkPair(int A[], int x)
    {   
        int size = A.length;
    ...
    // If input is invalid then [-1] is returned
    public int [] diffArrays(int a[], int b[])
    {
        int n = a.length;
        int m = b.length;
 ...
 public int findMaxCount(int myarr[])
    {   
        int len = myarr.length;
        int[] arr = new int[len];
        arr = mergeSort(myarr);
    ...
    public int findMinCount(int myarr[])
    {   
        int len = myarr.length;
        int[] arr = new int[len];
        arr = mergeSort(myarr);
